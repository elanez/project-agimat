 ...
 * @author Lance
 */
public class WaterAgimat extends Item {

    public WaterAgimat(Handler handler,int id) {
        super(handler,Assets.wAgimat, "Water Power", id);
    ...
    public Item createNew(int count) {
        Item i = new WaterAgimat(handler,id);
        i.setPickedUp(true);
        i.setCount(count);
        return i;
    }
