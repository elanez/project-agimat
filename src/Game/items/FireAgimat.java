 ...
 * @author Lance
 */
public class FireAgimat extends Item {

    public FireAgimat(Handler handler,int id) {
        super(handler,Assets.fAgimat, "Fire Power", id);
    ...
    public Item createNew(int count) {
        Item i = new FireAgimat(handler,id);
        i.setPickedUp(true);
        i.setCount(count);
        return i;
    }
