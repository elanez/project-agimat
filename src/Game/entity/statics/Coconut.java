 ...
 */
public class Coconut extends StaticEntity{

    public Coconut(Handler handler, float x, float y, int id) {
    ...
    public void render(Graphics graphics) {
        graphics.drawImage(Assets.coconut, (int)(x - handler.getCamera().getxOffset()), (int)(y -  handler.getCamera().getyOffset()),width,height, null);
