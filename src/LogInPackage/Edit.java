...
public class Edit extends javax.swing.JFrame{
    ...
    public Edit(String getID, boolean musicActive) {
        this.getID = getID;
...
//        });
    ...
    private void initComponents() {
        ...
        panel.add(btnCancel);
        btnCancel.setBounds(220, 460, 100, 30);
        ...
        jPanel1.add(panel);
        panel.setBounds(360, 150, 550, 550);
        jPanel1.add(bg);
        bg.setBounds(0, -20, 1340, 970);
            ...
            if((txtFirstname.getText() == null ? "" == null : txtFirstname.getText().equals("")) || (txtLastname.getText() == null ? "" == null : txtLastname.getText().equals(""))){
               JOptionPane.showMessageDialog(null, "ID or Name must contain value","System Message",JOptionPane.INFORMATION_MESSAGE);
                ...
                String selected = (rbMale.isSelected()) ? "Male":"Female";
                    ...
                    String sql = "UPDATE `info_tbl` SET `Username`= '" +txtUsername.getText()+ "' ,`Password`= '" +String.valueOf(txtPassword.getText()) +"' ,"
                            + "`First Name`='" + txtFirstname.getText() +"',`Last Name`= '" + txtLastname.getText() + "',`Birth_Month`= '" + (String)cmbMonth.getSelectedItem().toString() + "'"
                            + ",`Birth_Day`= '" + (String)cmbDay.getSelectedItem().toString() + "',`Birth_Year`='" + (String)cmbYear.getSelectedItem().toString() + "',`Sex`= '" + selected + "' WHERE `ID` = '"+getID+"'";
    ...
    public void loadData(){
        try{
            ...
            Connection conDB = DriverManager.getConnection("jdbc:mysql://localhost:3306/game", "root", "");
            Statement state = conDB.createStatement();
            ResultSet rs = state.executeQuery("SELECT * FROM info_tbl WHERE ID = '" + getID + "'");
            if(rs.next()){
...
//            new Edit("1",false).setVisible(true);
//        });
//    }
